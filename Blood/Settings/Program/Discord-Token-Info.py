...
try:
    ...
    print(f"{color.BLUE}{WAIT} Information Recovery..{reset}")
    try:
    ...
    print(f"""
    {white}[{blue}+{white}]{blue} Status       : {color.WHITE}{status}{color.BLUE}
    {white}[{blue}+{white}]{blue} Token        : {color.WHITE}{token_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Username     : {color.WHITE}{username_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Display Name : {color.WHITE}{display_name_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Id           : {color.WHITE}{user_id_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Created      : {color.WHITE}{created_at_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Country      : {color.WHITE}{country_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Email        : {color.WHITE}{email_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Verified     : {color.WHITE}{email_verified_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Phone        : {color.WHITE}{phone_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Nitro        : {color.WHITE}{nitro_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Linked Users : {color.WHITE}{linked_users_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Avatar Decor : {color.WHITE}{avatar_decoration_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Avatar       : {color.WHITE}{avatar_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Avatar URL   : {color.WHITE}{avatar_url_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Accent Color : {color.WHITE}{accent_color_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Banner       : {color.WHITE}{banner_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Banner Color : {color.WHITE}{banner_color_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Flags        : {color.WHITE}{flags_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Public Flags : {color.WHITE}{public_flags_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} NSFW         : {color.WHITE}{nsfw_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Multi-Factor Authentication : {color.WHITE}{mfa_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Authenticator Type          : {color.WHITE}{authenticator_types_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Billing      : {color.WHITE}{payment_methods_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Gift Code    : {color.WHITE}{gift_codes_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Guilds       : {color.WHITE}{guild_count}{color.BLUE}
    {white}[{blue}+{white}]{blue} Owner Guilds : {color.WHITE}{owner_guild_count}{owner_guilds_names}{color.BLUE}
    {white}[{blue}+{white}]{blue} Bio          : {color.WHITE}{bio_discord}{color.BLUE}
    {white}[{blue}+{white}]{blue} Friend       : {color.WHITE}{friends_discord}{color.BLUE}
    """)
    Continue()
    Reset()
except Exception as e:
