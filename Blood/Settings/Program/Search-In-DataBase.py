...
try:
    ...
    print(f"""
{BEFORE + current_time_hour() + AFTER} {INFO} Add DataBase to the "{white}{folder_database_relative}{blue}" folder.
{BEFORE + current_time_hour() + AFTER} {INFO} If you don't have a DataBase you can get one on the Discord Server "{white}{discord_server}{blue}\".""")
...
- Result : {white}{line_info}
    """)
                            ...
                            print(f"{BEFORE + current_time_hour() + AFTER} {ERROR} Error reading file \"{white}{element}{blue}\": {white}{e}")
                    except Exception as e:
                        print(f"{BEFORE + current_time_hour() + AFTER} {ERROR} Error reading file \"{white}{element}{blue}\": {white}{e}")
        ...
        if not results_found:
            print(f"{BEFORE + current_time_hour() + AFTER} {INFO} No result found for \"{white}{search}{blue}\".")
