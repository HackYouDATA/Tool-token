...
try:
    ...
    print(f"""
{white}[{blue}01{white}] {blue}->{white} Chrome (Windows / Linux)
{white}[{blue}02{white}] {blue}->{white} Edge (Windows)
{white}[{blue}03{white}] {blue}->{white} Firefox (Windows)
    """)
    ...
    Slow(f"""
{BEFORE + current_time_hour() + AFTER} {INFO} The username "{white}{username}{blue}" was found:

    {INFO_ADD} Tiktok     : {white}{tiktok_search()}{blue}
    {INFO_ADD} Instagram  : {white}{instagram_search()}{blue}
    {INFO_ADD} Snapchat   : {white}{snapchat_search()}{blue}
    {INFO_ADD} Giters     : {white}{giters_search()}{blue}
    {INFO_ADD} Github     : {white}{github_search()}{blue}
    {INFO_ADD} Paypal     : {white}{paypal_search()}{blue}
    {INFO_ADD} Telegram   : {white}{telegram_search()}{blue}
    {INFO_ADD} Linktree   : {white}{linktree_search()}{blue}
    {INFO_ADD} Roblox     : {white}{roblox_search()}{blue}
    {INFO_ADD} Streamlabs : {white}{streamlabs_search()}{blue}
    """)
