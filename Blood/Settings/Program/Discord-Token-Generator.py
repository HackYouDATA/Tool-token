    ...
    def token_check():
        ...
        try:
            try:
                ...
                print(f"{blue}[{white}{current_time_hour()}{blue}] {GEN_INVALID} Status: {color.WHITE}Invalid{color.BLUE} | Token: {color.WHITE}{token}{color.BLUE}")
        except:
            print(f"{blue}[{white}{current_time_hour()}{blue}] {GEN_INVALID} Status: {color.WHITE}Error{color.BLUE} | Token: {color.WHITE}{token}{color.BLUE}")
